  ...
  <div v-if="totalPages > 1" class="flex items-center justify-between border-t border-slate-900/60 pt-4 font-mono text-xs text-slate-400 select-none">
    ...
    <div class="flex items-center space-x-1">
      <button
        ...
        class="px-2.5 py-1 bg-light-bg-main dark:bg-slate-900 hover:bg-light-bg-sec dark:bg-slate-800 disabled:opacity-30 disabled:hover:bg-light-bg-main dark:bg-slate-900 border border-slate-800 font-bold uppercase transition"
      >
        Prev
      </button>
      ...
      <button
        ...
        :class="page === currentPage
                 ...
                 : 'bg-light-bg-main dark:bg-slate-950 text-slate-400 hover:bg-light-bg-main dark:bg-slate-900 hover:text-white border-slate-850'"
      >
        {{ page }}
      </button>
