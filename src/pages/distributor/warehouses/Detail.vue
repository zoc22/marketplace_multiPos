  ...
  <div class="space-y-6" v-if="warehouse">
    ...
    <div class="flex items-center justify-between mb-2">
      <div class="flex items-center space-x-3">
        <router-link to="/distributor/warehouses" class="p-2 bg-[var(--color-surface-hover)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] transition">
          <ArrowLeftIcon class="h-4 w-4" />
        </router-link>
        <div class="flex items-center space-x-2 text-sm text-[var(--color-text-secondary)] font-medium">
          <router-link to="/distributor/warehouses" class="hover:text-[var(--color-primary)] transition">Entrepôts</router-link>
    ...
    <div class="bg-[var(--color-surface-elevated)] border border-[var(--color-border)] rounded-2xl overflow-hidden shadow-sm">
      <div class="p-6 border-b border-[var(--color-border)] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex space-x-3">
          <router-link to="/distributor/warehouses/transfers" class="px-3 py-1.5 bg-[var(--color-surface-hover)] hover:bg-[var(--color-primary-muted)] text-[var(--color-text-primary)] border border-[var(--color-border)] rounded-lg text-xs font-semibold transition">
            Transfert de stock
          </router-link>
          <router-link to="/distributor/warehouses/adjustments" class="px-3 py-1.5 bg-[var(--color-surface-hover)] hover:bg-[var(--color-primary-muted)] text-[var(--color-text-primary)] border border-[var(--color-border)] rounded-lg text-xs font-semibold transition">
            Ajustement
          </router-link>
        </div>
      </div>
