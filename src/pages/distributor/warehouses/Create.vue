  ...
  <div class="space-y-6 max-w-4xl mx-auto">
    ...
    <form @submit.prevent="saveWarehouse" class="bg-[var(--color-surface-elevated)] border border-[var(--color-border)] rounded-2xl p-6 md:p-8 space-y-8 shadow-sm">
      ...
      <div class="flex justify-end space-x-3 pt-4 border-t border-[var(--color-border)]">
        <router-link to="/distributor/warehouses" class="px-5 py-2.5 bg-[var(--color-surface-hover)] border border-[var(--color-border)] text-[var(--color-text-primary)] rounded-lg text-sm font-semibold hover:bg-[var(--color-border)] transition">
          Annuler
        </router-link>
...
function saveWarehouse() {
  ...
  router.push('/distributor/warehouses');
}
</script>
