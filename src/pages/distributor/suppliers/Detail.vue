  ...
  <div class="space-y-6" v-if="supplier">
    ...
    <div class="flex items-center space-x-3 mb-2">
      ...
      <div class="flex items-center space-x-2 text-sm text-[var(--color-text-secondary)] font-medium">
        <router-link to="/distributor/suppliers" class="hover:text-[var(--color-primary)] transition">Fournisseurs</router-link>
...
import { b2b_suppliers, purchases } from '@/utils/distributor_db';
