<template>
  <div class="space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center space-x-3 mb-4">
      <router-link to="/distributor/suppliers" class="p-2 bg-[var(--color-surface-hover)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] transition">
    ...
    <form @submit.prevent="saveSupplier" class="bg-[var(--color-surface-elevated)] border border-[var(--color-border)] rounded-2xl p-6 md:p-8 space-y-8 shadow-sm">
      ...
      <div class="flex justify-end space-x-3 pt-4 border-t border-[var(--color-border)]">
        <router-link to="/distributor/suppliers" class="px-5 py-2.5 bg-[var(--color-surface-hover)] border border-[var(--color-border)] text-[var(--color-text-primary)] rounded-lg text-sm font-semibold hover:bg-[var(--color-border)] transition">
          Annuler
        </router-link>
...
function saveSupplier() {
  ...
  router.push('/distributor/suppliers');
}
</script>
