<template>
  <div class="min-h-screen bg-[#070b12] text-slate-100 flex flex-col justify-between">
    ...
    <section class="relative h-[25rem] sm:h-[28rem] lg:h-[32rem] overflow-hidden bg-slate-950 border-b border-[#14232c]/50">
          ...
          <div class="max-w-2xl space-y-4">
            ...
            <div class="pt-4 flex flex-wrap gap-3 items-center">
              ...
              <div class="px-4 py-2.5 bg-slate-900/90 backdrop-blur border border-[#162a33] text-slate-205 rounded-xl text-xs font-mono">
                ...
                <span class="text-accent-green font-bold ml-1.5">{{ slide.accent }}</span>
              </div>
            </div>
      ...
      <button 
        @click="prevSlide"
        class="absolute left-4 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-slate-950/60 hover:bg-emerald-950 border border-slate-900 text-slate-300 hover:text-accent-green flex items-center justify-center z-30 transition"
      >
        &larr;
      </button>
      <button 
        @click="nextSlide"
        class="absolute right-4 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-slate-950/60 hover:bg-emerald-950 border border-slate-900 text-slate-300 hover:text-accent-green flex items-center justify-center z-30 transition"
      >
        &rarr;
      </button>
      ...
      <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex space-x-2 z-30">
        <button 
          ...
          :class="activeSlide === sIdx ? 'w-6 bg-accent-green' : 'w-2 bg-slate-750'"
        ></button>
      </div>
    </section>
    ...
    <section class="py-10 bg-slate-950 px-4 md:px-8 overflow-hidden">
      <div class="max-w-6xl mx-auto space-y-4">
        <div class="flex justify-between items-end">
          <div>
            <span class="text-[9.5px] font-mono text-accent-green font-extrabold uppercase bg-emerald-950/40 px-2 py-0.5 rounded border border-emerald-900/30">LIVRAISON PORT DE KRIBI & DOUALA</span>
            <h2 class="text-lg font-bold text-slate-105 font-mono uppercase mt-1">⚡ OFFRES DE GROS FLASH (COOP-TO-B2B)</h2>
          </div>
          <div class="flex space-x-1">
            <button @click="scrollDealsLeft" class="px-2 py-1 bg-[#0d161d] hover:bg-emerald-950 border border-slate-900 rounded text-xs text-slate-400 hover:text-accent-green">&larr;</button>
            <button @click="scrollDealsRight" class="px-2 py-1 bg-[#0d161d] hover:bg-emerald-950 border border-slate-900 rounded text-xs text-slate-400 hover:text-accent-green">&rarr;</button>
          </div>
        </div>
          ...
          >
            ...
            <div class="flex space-x-3">
              ...
              <div class="truncate">
                ...
                <p class="text-[10.5px] font-mono text-accent-green mt-1">
            ...
            <div class="flex space-x-2 pt-1">
              ...
              <button 
                ...
                class="flex-1 py-1.5 bg-emerald-950 group-hover:bg-accent-green text-accent-green group-hover:text-slate-950 rounded-lg text-[9.5px] font-mono uppercase font-extrabold tracking-wider transition border border-emerald-900 group-hover:border-transparent flex justify-center items-center"
              >
                Grab Deal
              </button>
            </div>
        ...
        <aside class="space-y-6 lg:col-span-1 lg:sticky lg:top-24 h-fit bg-[#091016] border border-[#13252f]/40 p-5 rounded-2xl">
          ...
          <div class="space-y-2.5">
            ...
            <div class="flex flex-col space-y-1.5 max-h-40 overflow-y-auto pr-1 scrollbar-thin">
              <button 
                ...
                :class="!filters.sector ? 'bg-[#0e2226] text-accent-green font-bold' : 'text-slate-400 hover:text-slate-200'"
              >
              ...
              <button 
                ...
                :class="filters.sector === sec.name ? 'bg-[#0e2226] text-accent-green font-bold' : 'text-slate-450 hover:text-slate-205'"
              >
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-1.5 font-mono text-[10px]">
              <button 
                ...
                :class="!filters.stockOnly ? 'bg-emerald-950 border-emerald-800 text-accent-green' : 'bg-transparent border-[#152730] text-slate-450 hover:text-slate-205'"
              >
                All Lots
              </button>
              <button 
          ...
          <div class="space-y-2">
            ...
            <select 
              ...
              class="w-full bg-[#03060a] border border-[#142630] rounded-xl px-2.5 py-2 text-xs text-slate-300 focus:outline-none focus:border-accent-green font-mono text-[10.5px]"
            >
        ...
        <main class="lg:col-span-3 space-y-8">
          ...
          <div class="flex flex-wrap items-center justify-between gap-4 p-4 bg-[#091117] border border-slate-900 rounded-2xl text-xs">
            <div class="font-sans text-slate-400">
              ...
              <span class="text-accent-green font-bold">{{ sortedProducts.length }}</span> matches &bull; 
            ...
            >
              ...
              <div class="absolute top-3 right-3 z-10 flex space-x-1.5 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <button 
                  ...
                  class="h-7 w-7 rounded-lg bg-slate-950/80 backdrop-blur border text-slate-400 hover:text-accent-green flex items-center justify-center transition"
                  :class="cartStore.isInCompare(prod.id) ? 'border-accent-green text-accent-green font-bold' : 'border-slate-800'"
              ...
              <div class="p-4.5 space-y-3 flex-1 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <!-- Product Name -->
                  <h3 class="text-[13px] font-sans font-bold text-slate-102 leading-tight uppercase tracking-tight mt-1 group-hover:text-accent-green transition">
                    {{ prod.name }}
                  </h3>
                ...
                <div class="grid grid-cols-2 gap-2 pt-3 border-t border-[#0e2129]">
                  ...
                  <button 
                    ...
                    :class="prod.status === 'out_of_stock' || prod.stock <= 0 
                      ...
                      : 'bg-emerald-950 border-emerald-900 hover:bg-accent-green hover:text-slate-950 text-accent-green hover:border-transparent'"
                  >
          ...
          >
            ...
            <div class="flex items-center space-x-1.5 order-1 sm:order-2">
              ...
              <button 
                ...
                :class="currentPage === p 
                  ? 'bg-emerald-550 border border-accent-green text-white font-extrabold' 
                  : 'bg-slate-950 border border-slate-900 hover:bg-[#0c1f26] text-slate-400 hover:text-accent-green'"
              >
                {{ p }}
              </button>
    ...
    >
      ...
      <div 
        class="bg-[#080f14] border-2 border-emerald-900 rounded-3xl max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl p-6 md:p-8 space-y-6 relative text-xs"
        @click.stop
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div class="space-y-4">
            <div class="relative h-64 rounded-xl overflow-hidden border border-[#162a33] bg-slate-950/40">
              ...
              <div class="absolute bottom-3 left-3 bg-[#0d2126] text-accent-green text-[10px] font-mono px-2 py-0.5 rounded border border-emerald-900/60 font-bold uppercase">
          ...
          <div class="flex flex-col justify-between space-y-4">
            ...
            <div class="space-y-3">
              <span class="bg-[#0e2126] text-accent-green text-[9px] font-mono uppercase px-2.5 py-1 rounded font-bold border border-emerald-900/60 inline-block">
              ...
              <div class="py-2.5 border-t border-b border-slate-900 flex justify-between items-center bg-[#05070a] px-3 rounded-lg">
                <div>
                  ...
                  <p class="text-[17px] font-extrabold text-accent-green font-mono">
              ...
              <div class="flex items-center space-x-3.5">
                ...
                <div class="flex items-center space-x-1 font-mono bg-slate-950 p-1 border border-slate-900 rounded-lg">
                  ...
                  <input 
                    ...
                    class="w-14 bg-transparent border-none text-center text-xs text-accent-green font-bold focus:ring-0"
                    min="1"
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              <div class="flex items-start space-x-3">
                ...
                <div class="truncate">
                  <h4 class="text-[11px] font-bold text-slate-205 leading-normal truncate group-hover:text-accent-green transition">{{ sim.name }}</h4>
      ...
      <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="space-y-3">
          <div class="flex items-center space-x-2">
            <div class="h-6 w-6 bg-accent-green rounded flex items-center justify-center text-slate-950 text-xs font-bold font-mono">K</div>
