<template>
  <div class="space-y-6" v-if="dn">
    ...
    <div class="flex items-center space-x-3 mb-2">
      <router-link to="/supplier/purchases/delivery-notes" class="p-2 bg-[var(--color-surface-hover)] border border-[var(--color-border)] rounded-lg text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] transition">
        <ArrowLeftIcon class="h-4 w-4" />
      </router-link>
      <div class="flex items-center space-x-2 text-sm text-[var(--color-text-secondary)] font-medium">
        <router-link to="/supplier/purchases/delivery-notes" class="hover:text-[var(--color-primary)] transition">Bons de livraison</router-link>
