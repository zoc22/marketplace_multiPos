            ...
            >
              <div>
                <div class="flex justify-between items-start">
                  ...
                  <span class="text-[9px] bg-[#0d2126] text-emerald-400 font-mono px-1.5 rounded uppercase font-bold text-[8px]">
                    IGP
                  </span>
                </div>
                <h3 class="text-[11.5px] font-bold text-slate-201 mt-1.5 leading-snug group-hover:text-emerald-400 transition uppercase">
                  {{ cat.name }}
                </h3>
              </div>
