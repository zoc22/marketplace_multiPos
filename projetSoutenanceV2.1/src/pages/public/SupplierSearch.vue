      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div class="flex items-start space-x-3.5">
            <div class="h-11 w-11 rounded-xl bg-[#0c2020] border border-emerald-950/55 flex items-center justify-center text-xl text-emerald-400 shrink-0">
              🏢
            </div>
            <div class="truncate">
          ...
          <div class="pt-3 border-t border-slate-900 flex justify-between items-center text-[10px] font-mono">
            ...
            <button 
              ...
              class="px-3.5 py-1.5 bg-emerald-955 text-emerald-400 hover:bg-emerald-400 hover:text-slate-950 font-bold uppercase rounded-lg border border-emerald-900 hover:border-transparent transition"
            >
              Voir ses lots &rarr;
            </button>
          </div>
