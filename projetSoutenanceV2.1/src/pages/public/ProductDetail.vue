      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
        ...
        <div class="md:col-span-5 space-y-6">
          <div class="relative rounded-3xl overflow-hidden bg-[#091116] border border-[#142a34] group">
            ...
            <div class="absolute top-4 left-4 bg-emerald-950 text-emerald-400 text-[9px] font-mono px-2.5 py-1 rounded border border-emerald-900/60 font-bold uppercase">
        ...
        <div class="md:col-span-7 space-y-6">
          ...
          <div class="space-y-3">
            <span class="bg-[#0e2126] text-emerald-400 text-[9.5px] font-mono uppercase px-2.5 py-1 rounded font-bold border border-emerald-900/60 inline-block">
          ...
          <div class="py-4 px-5 bg-gradient-to-r from-slate-950 to-[#0a151b] border border-[#12242d] rounded-2xl flex justify-between items-center font-mono">
            <div>
              ...
              <p class="text-[20px] font-extrabold text-emerald-400">
          ...
          >
            <div class="space-y-3">
              ...
              <div>
                ...
                <h3 class="text-xs font-bold text-white uppercase leading-normal mt-1 truncate group-hover:text-emerald-400 transition" :title="sim.name">
                  {{ sim.name }}
                </h3>
              </div>
            </div>
