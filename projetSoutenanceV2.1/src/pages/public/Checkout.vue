            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="space-y-1.5">
                ...
                <input 
                  ...
                  class="w-full bg-[#03060a] border border-[#142630] rounded-xl px-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-emerald-500 font-mono placeholder-slate-650"
                />
              </div>
            ...
            <div class="p-3.5 bg-slate-950 rounded-xl border border-slate-900 space-y-2.5">
              <div class="flex items-start space-x-2.5">
                ...
                <label for="escrow_check" class="text-[10px] text-slate-400 select-none leading-relaxed cursor-pointer">
                  Je certifie que les fonds déclarés de <span class="text-emerald-400 font-bold uppercase">{{ formatCFA(grandTotal) }}</span> proviennent d'une trésorerie vérifiée et consens à les bloquer sous l'arbitrage fiduciaire de KONG S.A.
                </label>
              </div>
            </div>
            ...
            <div class="space-y-3.5 pt-2">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div 
                  ...
                  :class="selectedMethod === method.id ? 'border-emerald-500 text-emerald-400 font-bold' : 'border-slate-900 text-slate-400'"
                >
